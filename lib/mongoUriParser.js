 ...
 * @return {Object}
 */
MongodbUriParser.parse = function parse(uri) {
  ...
  MongodbUriParser._parseAddress(rest, uriObject);
 ...
 * @private
 */
MongodbUriParser._parseAddress = function _parseAddress(address, uriObject) {
  uriObject.hosts = [];
 ...
 * @return {String}
 */
MongodbUriParser.format = function format(uriObject) {

  if (!uriObject) {
    return 'mongodb://localhost';
  }

  var uri = uriObject.scheme ? (uriObject.scheme + '://') : '';
  ...
  uri += MongodbUriParser._formatAddress(uriObject);
 ...
 * @private
 */
MongodbUriParser._formatAddress = function _formatAddress(uriObject) {
  var address = '';
 ...
 * @return {String}
 */
MongodbUriParser.formatMongoose = function formatMongoose(uri) {
  var parser = MongodbUriParser;
